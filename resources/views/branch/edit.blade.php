...
@section('content')
    <div class="content">
        ...
        {{-- {{dd($branch)}} --}}
        <form action="{{ route('branch.update', $branch->id) }}" method="POST" class=" form-updated validate-form">
            @csrf
            <div class="grid grid-cols-12 gap-2 grid-updated">
                <div class="input-form col-span-3 mt-3">
                    ...
                    <input id="branch_name" type="text" name="name" class="form-control field-new"
                        placeholder="Enter Branch name" required maxlength="255" value="{{ $branch->name }}">
                </div>
                ...
                <div class="input-form col-span-3 mt-3">
                    ...
                    <textarea id="branch_address" name="address" class="form-control field-new" placeholder="Enter address"> {{$branch->location}} </textarea>
                </div>
                ...
                <div class="input-form col-span-3 mt-3">
                    ...
                    <input id="latitude" type="text" name="latitude" class="form-control field-new" maxlength="255" value="{{ $branch->latitude }}">
                </div>
                ...
                <div class="input-form col-span-3 mt-3">
                    ...
                    <input id="longitude" type="text" name="longitude" class="form-control field-new" maxlength="255" value="{{ $branch->longitude }}">
                </div>
                ...
                <div class="input-form col-span-3 mt-3">
                    ...
                    <input id="gst_no" type="text" name="gst_no" class="form-control field-new"
                        placeholder="Enter phone number" required maxlength="15" value="{{ $branch->gst_no }}">
                </div>
